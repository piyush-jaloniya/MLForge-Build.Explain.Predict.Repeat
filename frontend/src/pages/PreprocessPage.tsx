...
export default function PreprocessPage() {
  ...
  const shownRows = Math.min(preview.length, previewRowLimit)
            ...
            <div className="space-y-4 relative z-10">
              <div className="space-y-1.5">
                ...
                <DropdownSelect
                  ...
                  options={[{ value: '', label: '-- Required --' }, ...cols.map((c) => ({ value: c, label: c }))]}
        ...
        <div className="xl:col-span-8 space-y-4 flex flex-col">
          ...
          <div className="bg-surface border border-border rounded-2xl overflow-hidden shadow-sm flex-1 flex flex-col min-h-[500px]">
            <div className="p-4 bg-surface-hover/50 border-b border-border flex justify-between items-center">
              ...
              <span className="text-xs font-semibold text-slate-400 bg-surface border border-border px-2 py-0.5 rounded-full">Showing Top {shownRows} Rows</span>
            </div>
            ...
            <div className="overflow-x-auto flex-1 custom-scrollbar">
              <table className="w-full text-left text-sm whitespace-nowrap">
                ...
                <tbody className="divide-y divide-border/50">
                  {preview.slice(0, previewRowLimit).map((row, i) => (
