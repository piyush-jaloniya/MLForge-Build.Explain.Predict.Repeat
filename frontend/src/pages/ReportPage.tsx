        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2 px-3 py-1 bg-surface-hover border border-border rounded-xl">
             ...
             <select 
               ...
               className="bg-transparent border-none text-sm font-semibold focus:outline-none text-foreground py-2 outline-none appearance-none min-w-[150px]"
             >
          ...
          <AnimatePresence>
            {report && (
              <motion.button 
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl text-sm font-bold transition-all shadow-sm active:scale-95 border border-emerald-400 ml-auto"
              >
